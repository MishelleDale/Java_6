...
public class LaptopModels {
    ...
    private static TreeSet<LaptopModels> modelsSet = new TreeSet<>(new Comparator<LaptopModels>() {
        @Override
        public int compare(LaptopModels o1, LaptopModels o2) {
            return (o1.ram - o2.ram) - (o1.price - o2.price) -
                    (o1.hardDrive - o2.hardDrive) - (o1.screenDiagonal - o2.screenDiagonal);
        }
    });
    ...
    public String searchModels() {
        ...
        else return "Nothing was found for your request.";
    }
